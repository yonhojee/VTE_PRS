...
tmpVTE <- tempfile(tmpdir = "/n/holyscratch01/kraft_lab/yjee/VTE/scratch")
on.exit(file.remove(paste0(tmpVTE, ".sbk")), add = TRUE)

path2 <- snp_readBed2("/n/holyscratch01/kraft_lab/yjee/VTE/Processed_Data/VTEhumancore_imputed_Rsq095.bed", backingfile = tmpVTE)
...
# load SNP list
```{r}
info_snp_new_EUR<-readRDS("/n/holyscratch01/kraft_lab/yjee/VTE/Processed_Data/info_snp_EUR")
info_snp_new_AFR<-readRDS("/n/holyscratch01/kraft_lab/yjee/VTE/Processed_Data/info_snp_AFR")
```
...
# load beta_auto
```{r}
beta_auto_EUR<-readRDS("/n/holyscratch01/kraft_lab/yjee/VTE/Processed_Data/beta_auto_EUR.Jun_10_2022") #604741     48
beta_auto_AFR<-readRDS("/n/holyscratch01/kraft_lab/yjee/VTE/Processed_Data/beta_auto_AFR.Apr_03_2022") #1184805      48
```
